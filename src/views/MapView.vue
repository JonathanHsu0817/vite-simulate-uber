  ...
  <div id="MapView">
    ...
    <div id="VehicleSelection" class="w-full">
      ...
      <div class="scrollSection">
        ...
        <div class="flex justify-center bg-white py-6 px-4 w-full bottom-0 shadow-inner">
...
const getDirections = (map, directionsRenderer, directionsService) => {
  ...
  const request = {
    ...
    // set to true if you want google to determine the shortest route
    // or false to use the order specified.
    travelMode: 'DRIVING',
  };
...
const getDistance = async () => {
  const res = await axios.get(`distance/${direction.pickup}/${direction.destination}`);
